...
const About = () => {
    ...
    useGSAP(() => {
        ...
        // gsap.utils.toArray('.pop').forEach((el, index) => {
    ...
    return (
        <section ref={containerRef} className='relative overflow-hidden text-color1 py-10'>
            <div className='  relative'>
                <div className=' max-w-4xl mx-auto mb-32 max-md:mx-4'>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div className=" pop relative p-6 rounded-xl  bg-background/5 backdrop-blur-sm border border-blue1/10 hover:border-blue1/30 transition-all duration-300 group" >
                        ...
                        <div className="pop relative p-6 rounded-xl bg-white/5 dark:bg-black/5 backdrop-blur-sm border border-blue1/10 hover:border-blue1/30 transition-all duration-300 group" >
